...
def handler(event, context):
  ...
  s3.download_file('electri_image_uploads',path, '/tmp/img.png')
  ...
  upload_path = 'preprocessed_images/'+execution_name+'.png'
  s3.upload_file('/tmp/img_foreground.png', 'electri_upload_images', upload_path)
